...
class Plot:
    """Dash app wrapper for plotting backtest results."""

    # Settings (constants)
    CHART_BG = "#1f2c56"

    # State (class-level defaults; overwritten on instance)
    ...
    start_date_datetime: datetime.datetime | int = 0
    end_date_datetime: datetime.datetime | int = 0

    para_combination: dict = {}
    net_profit_to_mdd = 0
    net_profit = 0
    mdd_dollar = 0
    mdd_pct = 0
    num_of_trade = 0
    num_of_win: int | str = 0
    return_on_capital = 0
    total_commission = 0
    year_list: list[int] = []
    year_count: list = []
    ...
    def __new__(self, all_para_combination, result_df, settings, number_of_curves):
        # start_date, end_date and para_dict are the same for all combinations, so use the first one
        ...
        df_col = pd.DataFrame([["-----" for _ in col_df]], columns=col_df)
        performance_matrix = components.update_performance_matrix(
            start_date,
            end_date,
            df_col.iloc[0].copy(),
            para_dict,
                                ...
                                html.Div(
                                    [
                                        ...
                                        dbc.Row(
                                            [
                                                dbc.Col(
                                                    id="filter_dropdown_div",
                                                    children=filter_dropdown,
                                                    width=8,
                                                ),
                                                dbc.Col(
                                                    id="filter_input_div",
                                        ...
                                        html.Div(
                                            id="add_button",
                                            children=html.Div(
                                                [html.Div(style={"height": "5px"}), "Add Filter"]
                                            ),
                                        ...
                                        html.Div(
                                            ...
                                            children=[
                                                ...
                                                html.Div(
                                                    id="chart_area",
                                                    children=dcc.Graph(
                                                        id="line_chart", figure=empty_line_chart
                                                    ),
                                                ),
                                                html.Div(style={"height": "10px"}),
                                            ],
                                                                    ...
                                                                    [
                                                                        ...
                                                                        dcc.DatePickerRange(
                                                                            ...
                                                                            start_date=datetime.date(
                                                                                self.start_date_datetime.year,
                                                                                self.start_date_datetime.month,
                                                                                self.start_date_datetime.day,
                                                                            ),
                                                                            end_date=datetime.date(
                                                                                self.end_date_datetime.year,
                                                                                self.end_date_datetime.month,
                                                                ...
                                                                children=html.Div(
                                                                    ...
                                                                    children=html.Div(
                                                                        [
                                                                            ...
                                                                            "Show Intra Day Candlestick Chart",
                                                                        ]
                                                                    ),
                                                                    style={
                                                                        "margin": "0px",
        ...
        @app.callback(
            ...
            [Input(f"button_{i}", "n_clicks") for i in range(10)],
        )
        def display_output(
            sort_method,
            para_checklist,
            ...
            filter_div,
            add_button_clicks,
            chart1_button_clicks,
            chart2_button_clicks,
            chart3_button_clicks,
            chart3_back_button_clicks,
            _add_button_style,
            filter_name,
            filter_input_value,
            hist_area,
            hist_style,
            main_chart_area_style,
            ...
            *vals,
            ...
            if chart3_button_clicks and chart3_button_clicks > self.chart3_button_clicks:
                ...
                if chart3_start_str and chart3_end_str:
                    ...
                    delta = chart3_end - chart3_start

                    if (delta.days > 60) or (delta.days < 1):
                        ...
                        chart3_chart = components.generate_chart_3(
                            para_combination,
                            chart3_start,
                            chart3_end,
                            freq,
            ...
            if chart3_back_button_clicks and chart3_back_button_clicks > self.chart3_back_button_clicks:
            ...
            if chart1_button_clicks and chart1_button_clicks > self.chart1_button_clicks:
            ...
            if chart2_button_clicks and chart2_button_clicks > self.chart2_button_clicks:
                ...
                if self.line_selected > -1:
                    ...
                    if intraday:
                        ...
                        chart3_start_str = datetime.date(
                            self.start_date_datetime.year,
                            self.start_date_datetime.month,
                            self.start_date_datetime.day,
                        )
                        chart3_end_str = datetime.date(
                            self.end_date_datetime.year,
                            self.end_date_datetime.month,
                            self.end_date_datetime.day,
                        )
                    ...
                    for p in period:
                        title_list.append(
                            dbc.Col(f"{p} Days", style={"font-size": "12px", "text-align": "center"}, width=2)
                        )
                    ...
                    hist_area = [
                        html.Div(style={"height": "5px"}),
                        html.Div(dbc.Row(title_list)),
                        html.Div(dbc.Row(pct_list)),
                        html.Div(dbc.Row(rise_list)),
                        html.Div(dbc.Row(fall_list)),
                        html.Div(style={"height": "5px"}),
                    ]
                    hist_style = {"padding": "5px", "border-radius": "5px", "background-color": chart_bg}
            ...
            if not self.init:
                if not add_button_clicks and not chart1_button_click:
            ...
            if add_button_clicks:
                if add_button_clicks > self.add_button_count:
                    self.add_button_count = add_button_clicks
                    if filter_name and filter_input_value:
                ...
                self.add_button_count = 0  # needed for initialization

            # Filter delete button pressed: remove one filter
            for i in range(len(vals)):
                if vals[i] != self.button_list[i]:
                    self.filter_list.pop(i)
                    filter_div = components.update_filter_div(self.filter_list)
                    self.add_button_count = -1  # needed for add button count
            ...
            if sort_method:
                ...
                if para_checklist:
                    and_list = []
                    for i, key in enumerate(para_key_list):
                        or_list = []

                        for element in para_checklist[i]:
                            # Convert HK stock code back to int
                            if key == "code":
                                try:
                                    element = int(element)
                                except Exception:
                            ...
                            or_list.append(current_df[key] == element)

                        or_mask = np.logical_or.reduce(or_list)
                        and_list.append(or_mask)

                    and_mask = np.logical_and.reduce(and_list)
                    df_checked = current_df.loc[pd.DataFrame(and_mask, columns=["check"])["check"]].reset_index(
                        drop=True
                    )
                else:
        ...
        def update_matrix(clickData, performance_matrix):
            ...
            if clickData and self.chart_type == 1:
                ...
                para_combination = (
                    df_all_para_combination.loc[df_all_para_combination["reference_index"] == reference_index]
                    .to_dict("records")[0]
                )
        ...
        def select_all_none(selected_all, options):
            ...
            if selected_all == ["All"]:
                if self.select_all_status is False:
                    options[0] = code_list
                    self.select_all_status = True
            else:
                if self.select_all_status is True:
                    options[0] = []
            ...
            if not self.init:
                if not save_clicks:
                    ...
                    if self.line_selected > -1:
                        ...
                        button_available = save_path not in list(saved_df["path"])
                    ...
                    if save_clicks > self.save_clicks:
                        ...
                        if self.line_selected > -1:
                            ...
                            if save_path not in list(saved_df["path"]):
                                para_pop = self.para_combination.copy()
                                para_pop.pop("df", None)
                                para_pop.pop("holiday_list", None)
                                ...
                                saved_df = pd.concat(
                                    [saved_df, pd.DataFrame(df_dict, index=[10])],
                                    ignore_index=True,
                                )
